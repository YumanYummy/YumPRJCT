...
int main(){
    ...
    for (int c_a = 0; nimcek[c_a]!='\0'; c_a++) {
      if(nim[c_a] >= 0x21 && nimcek[c_a] <= 0x2F) {
                 ...
                 printf(" Silahkan Input NIM Sesuai Contoh Diatas\n");
                 printf(" Press Enter....");
                 getch();
                 system("cls");
      	         goto inputNIM;
        ...
        if(strlen(nimcek)>=17){
            printf(" NIM Yang Di Input Tidak Boleh Lebih Dari 17 Karakter\n");
            printf(" Press Enter....");
            getch();
            system("cls");
            goto inputNIM;
        ...
        if(strlen(nimcek)<=17){
            printf(" NIM Yang Di Input Harus 17 Karakter\n");
            printf(" Press Enter....");
            getch();
            system("cls");
            goto inputNIM;
    ...
    case 2:
     ...
     data=0;
        ...
        if(data == 0){
            ...
            printf(" Silahkan Input Data Terlebih Dahulu\n");
        }
